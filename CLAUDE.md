...
Подробности — в глобальном `~/.claude/CLAUDE.md` (разделы «Никогда
не пушить напрямую в main», «Один PR — один коммит», «Code review
каждого PR») и в `README.md` (раздел «Git workflow»).
