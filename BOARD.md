...
git, без внешних сервисов и инструментов. Заводить **опционально** —
когда задач в проекте действительно много и их статус хочется видеть
визуально. Для проектов с 2-3 задачами это лишнее.
