...
**Точки входа (без зависимостей):** T043, T048, T050 (T033/T034/T035
закрыты 2026-07-30; следующие точки входа с выполненными deps — T036, T037).
...
<!-- T034 (базовые операции над задачами) и T035 (валидация и готовность)
     закрыты 2026-07-30 — см. BOARD.md → Done и CHANGELOG [Unreleased]. -->
