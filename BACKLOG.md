...
**Точки входа (без зависимостей):** T043, T048, T050 (T033/T034/T035/T036
закрыты 2026-07-30; следующие точки входа с выполненными deps — T037, T038).
...
<!-- T034 (базовые операции), T035 (валидация и готовность), T036
     (размещение и жизненный цикл worktree) закрыты 2026-07-30 — см.
     BOARD.md → Done и CHANGELOG [Unreleased]. -->
