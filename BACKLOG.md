...
**Точки входа (без зависимостей):** T043, T048, T050 (T033–T041 + T051 + T052
закрыты; T042 разблокирован — deps T034+T040 выполнены — но это точка
невозврата, брать после T051–T053; следующий по крит.пути — T053).
...
<!-- T051 (dt context) и T052 (SessionStart-хук + реестр сессий) закрыты —
     см. BOARD.md → Done и CHANGELOG [Unreleased]. -->
