...
**Точки входа (без зависимостей):** T043, T048, T050 (T033–T039
закрыты; следующая точка входа с выполненными deps — T040).
...
<!-- T034 (базовые операции), T035 (валидация), T036 (worktree),
     ...
     dt task start) закрыты — см. BOARD.md → Done и CHANGELOG [Unreleased]. -->
