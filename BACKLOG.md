...
**Точки входа (без зависимостей):** T043, T048, T050 (T033–T037
закрыты 2026-07-30; следующие точки входа с выполненными deps — T038, T039).
...
<!-- T034 (базовые операции), T035 (валидация и готовность), T036
     (worktree), T037 (текстовая доска dt board) закрыты 2026-07-30 —
