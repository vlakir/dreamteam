...
**Точки входа (без зависимостей):** T043, T048, T050 (T033–T038
закрыты 2026-07-30; следующие точки входа с выполненными deps — T039, T040).
...
<!-- T034 (базовые операции), T035 (валидация), T036 (worktree),
     T037 (доска dt board), T038 (поиск dt task find) закрыты
     2026-07-30 — см. BOARD.md → Done и CHANGELOG [Unreleased]. -->
