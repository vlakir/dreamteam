...
2026-07-30; T034 взята в работу — `BOARD.md → Doing`).
...
<!-- T034 (базовые операции над задачами) взята в работу 2026-07-30 —
     переехала в `BOARD.md → Doing`. Спека: `specs/T034-task-ops/spec.md`. -->
