...
**Точки входа (без зависимостей):** T043, T048, T050 (T033–T040
закрыты; следующая точка входа с выполненными deps — T041).
...
<!-- T034 (базовые операции), T035 (валидация), T036 (worktree),
     ...
     dt task start), T040 (синхронизация BACKLOG.md dt backlog sync) закрыты —
